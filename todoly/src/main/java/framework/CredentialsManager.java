...
public class CredentialsManager {
    ...
    private static final String envFilePath = System.getProperty("user.dir") + File.separator + "TLEnvironments.json";
    private static final String usersFilePath = System.getProperty("user.dir") + File.separator + "TLUsers.json";
